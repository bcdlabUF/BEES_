...
path_source   = '/Users/i.dasilvaandrade/Desktop';

% folder where you have the channel location file
chanlocfolder = '/Users/i.dasilvaandrade/Documents/GitHub/BCDLAB_FTAG_beta001/acquisition_layout_information';
chanlocfile   = 'GSN-HydroCel-129.sfp'; % channel location file

% parameter file location
paramFilePath = '/Users/i.dasilvaandrade/Documents/GitHub/BCDLAB_FTAG_beta001/Infants';
paramFileName = 'LISA_BEBES_1.mat';

%
% Subjects' spreadsheet (be sure you are using the right spreadsheet per session (pre/post) )
%
spsheet = '/Users/i.dasilvaandrade/Dropbox (UFL)/BEES_ERPTRAIN/PreProcess_BEES_Andrade_2023_Feb/BEES_Counterbalance.xlsx';
...
%                         badchanindx_happe = find(ismember({EEG.chanlocs.labels}, lbl2int));
                        ...
                        if lbch>0
                                ...
                                dataQC{kdata,3} = dataQC{kdata,2} - size(badchanindx_all,2);
                ...
                if params.segment.interp
                        ...
                        elseif length(badchanindx_all)<(EEG.nbchan*propbadch) && isempty(badchanindx_all)
                           dataQC{kdata,7} = 'None, all good!' ; 
                        else                              
